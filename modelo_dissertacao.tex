...
\section{} % questão c
    O diagrama de ramo em folhas pode ser visualizado na imagem \ref{fig:questao17_c}
    
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.5\textwidth]{questao17_c.jpg}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.5\textwidth]{questao17D.png} 
