...
\programa{Discplina de Probabilidade e Estatística} % nome do programa
\area{Computação} % [Engenharia Biom\'edica] ou [Inform\'atica Industrial] ou [Telem\'atica]

\documento{APS} % [Disserta\c{c}\~ao] ou [Tese]
\nivel{Bacharelado} % [Mestrado] ou [Doutorado]
\titulacao{Ensino Médio} % [Mestre] ou [Doutor]

\titulo{{Trabalho individual de probabilidade e estatística}} % titulo do trabalho em portugues
\title{\MakeUppercase{Title in English}} % titulo do trabalho em ingles

\autor{José Moscardi da Silva Junior} % autor do trabalho
\cita{MOSCARDI, José} % sobrenome (maiusculas), nome do autor do trabalho
...
\comentario{\UTFPRdocumentodata\ requerida pela \UTFPRprogramadata\ da \ABNTinstituicaodata\ como requisito parcial para o fechamento da nota semestral.}

\orientador[Orientadora:]{Silvana Heidemann Rocha } % <- no caso de orientadora, usar esta sintaxe
...
%resumo
\begin{resumo}
Este trabalho apresenta a resolução da atividade prática supervisionada (APS) da disciplina de Probabilidade e Estatística.
\end{resumo}
...
\input{./Questoes/Questao1/questao1.tex}
\input{./Questoes/Questao2/questao2.tex}
\input{./Questoes/Questao3/questao3.tex}
\input{./Questoes/Questao4/questao4.tex}
\input{./Questoes/Questao5/questao5.tex}
\input{./Questoes/Questao6/questao6.tex}
\input{./Questoes/Questao7/questao7.tex}
\input{./Questoes/Questao8/questao8.tex}
\input{./Questoes/Questao9/questao9.tex}
\input{./Questoes/Questao10/questao10.tex}
\input{./Questoes/Questao11/questao11.tex}
\input{./Questoes/Questao12/questao12.tex}
\input{./Questoes/Questao13/questao13.tex}
\input{./Questoes/Questao14/questao14.tex}
\input{./Questoes/Questao15/questao15.tex}
\input{./Questoes/Questao16/questao16.tex}
\input{./Questoes/Questao17/questao17.tex}
\input{./Questoes/Questao18/questao18.tex}
\input{./Questoes/Questao19/questao19.tex}
\input{./Questoes/Questao20/questao20.tex}
\input{./Questoes/Questao21/questao21.tex}
\input{./Questoes/Questao22/questao22.tex}
...
\chapter{} % questão 17
\section{} % questão a
    Nesta caso a variável é o consumo mensal de água de uma amostra da empresa Água para Todos e sua unidade de medica é em metros cúbicos.
    
    Esta variável pode ser classificada como quantitativa discreta e sua escala e métrica de razão.
\section{} % questão b
    
\begin{table}[!htb]
\centering
	\label{tab:questao17_b}
	\begin{tabular}{ c c }
		\hline 
		...
		Primeiro Quartil & 15 \\
		Mediana & 17 \\
		Terceiro Quartil & 20.25 \\
		Média & 16.975 \\
		Moda(s) & 15 e 21 \\
		Variância & 19.56346 \\
		Desvio Padrão & 4.42306 \\
		Coeficiente de variação amostral & 26.05632 \\
		Coeficiente de assimetria & -0.01695659 \\
		Coeficiente de curtose & -60.35 \\
		\hline 
	\end{tabular}
	\caption[Tabela do problema 17]{Tabela com múltiplos dados sobre o rol apresentado}
	\fonte{Autoria própria.}
\end{table}

\section{} % questão c
    O diagrama de ramo em folhas pode ser visualizado na figura \ref{fig:questao17_c}
    
\begin{figure}[!htb]	
	\centering
	\includegraphics[width=0.5\textwidth]{./Imagens/questao17C.png}
	\caption[Questão 17 - ramo e folhas]{Imagem do diagrama de ramo e folhas gerado no RStudio}
	\fonte{Autoria Própria}
	\label{fig:questao17_c}
\end{figure}

\section{} % questão d
    O gráfico de box plot pode ser visualizado na figurayouyou \ref{fig:questao17_d}

\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.5\textwidth]{./Imagens/questao17D.png} 
	\caption[Questão 17 - box plot]{Imagem do box plot gerado no RStudio}
	\fonte{Autoria Própria}
	\label{fig:questao17_d}
\end{figure}
...
%---------- Apendices (opcionais) ----------
\apendice
\chapter{Trabalho individual de probabilidade e estatística}
